...
textarea && (textarea.onkeydown = function(event) {
 //support tab on textarea
	if (event.keyCode == 9) { //tab was pressed
		var newCaretPosition;
		var space_lg = "    ";// 4 space
		newCaretPosition = textarea.getCaretPosition() + space_lg.length; 
		console.log(newCaretPosition);
		textarea.value = textarea.value.substring(0, textarea.getCaretPosition()) + space_lg + textarea.value.substring(textarea.getCaretPosition(), textarea.value.length);
